...
class Report:
    ...
    def __buildvars__(self,args=""):
        self.dtemp= os.environ["USERPROFILE"] + "\\Documents\\Temp"
        try:
            os.mkdir(self.dtemp)
        except Exception:
            pass
    ...
    def __Generate__(self):
        ...
        temp= {
            "OS": self.form.OS,
            "PACIENTE": self.form.paciente,
            "DENTISTA": self.form.dentista,
            "Superior": sup,
            "Inferior": inf
            }
        self.total.update(temp)
        file= open(r"C:\Program Files\PyReport\Report.svg","r")
        xml= file.read()
