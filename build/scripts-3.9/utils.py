...
class auxtools(object):
    ...
    def Header(self):
        ...
        img= ImageReader(r"C:\Program Files\PyReport-1900x1080\build\exe.win-amd64-3.9\imgs\OrthoAligner.png")
        self.pdf.scale(1,-1)
        imgw= 250
    ...
    def rodape(self):
        ...
        img= ImageReader(r"C:\Program Files\PyReport-1900x1080\build\exe.win-amd64-3.9\imgs\Compass3D.png")
        self.pdf.scale(1,-1)
